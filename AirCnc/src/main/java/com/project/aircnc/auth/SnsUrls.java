...
public interface SnsUrls {
	...
	// 토큰 요청 URL
		public static final String GOOGLE_ACCESS_TOKEN = "https://oauth2.googleapis.com/token?grant_type=authorization_code"; 
	...
	//google cope URL 
	public static final String GOOGLE_SCOPE = "https://www.googleapis.com/auth/drive.file";
